...
def evaluate_calculation(): #do not use eval() because it also processes a code which is security issue or bug
    global calculation
    try:
...
text_result= cal.Text(root,height=2,width=16, font=("Arial",24))
...
btn_0=cal.Button(root, text="0", command=lambda: add_to_calculation(0), width=5, font=("Arial",14))
btn_0.grid(row=5,column=2)
btn_plus=cal.Button(root, text="+", command=lambda: add_to_calculation("+"), width=5, font=("Arial",14))
btn_plus.grid(row=2,column=4)
btn_minus=cal.Button(root, text="-", command=lambda: add_to_calculation("-"), width=5, font=("Arial",14))
...
btn_open=cal.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("Arial",14))
btn_open.grid(row=5,column=1)
btn_close=cal.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Arial",14))
btn_close.grid(row=5,column=3)
btn_clear=cal.Button(root, text="C", command=clear_field, width=11, font=("Arial",14))
btn_clear.grid(row=6,column=1,columnspan=2)
btn_equals=cal.Button(root, text="=", command= evaluate_calculation, width=11, font=("Arial",14))
